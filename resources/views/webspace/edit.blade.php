          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 text-right">
                <a href="{{ route('webspace.list') }}" class="btn btn-sm btn-warning">{{ __('Back to list') }}</a>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                    ...
                    @if (count($accesses))
                      ...
                      <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" value="{{$access->id}}" name="access[]" {{(in_array($access->id, $webspace->accesses()->get()->pluck('id')->toArray())) ? "checked": "" }}>
                            {{$access->name}}
