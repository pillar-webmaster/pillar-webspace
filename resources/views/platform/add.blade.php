          ...
          <div class="card-body">
            <form method="POST" action="{{ route('platform.create') }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="version" name="version" aria-describedby="versionHelp" placeholder="Enter version">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="requirements" name="requirements" rows="8" aria-describedby="requirementsHelp"></textarea>
